...
public partial class AddPrepaidCreditPage : AppPage
{
    private const double FormMaxWidth = 640;

    private readonly AddPrepaidCreditViewModel _viewModel;

    public AddPrepaidCreditPage(AddPrepaidCreditViewModel viewModel)
    {
        InitializeComponent();
